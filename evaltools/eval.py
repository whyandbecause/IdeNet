...
if __name__ == '__main__':
    ...
    parser.add_argument("--pred_root", default='/dataset2/gjw/result/'+model_name)
    parser.add_argument("--GT_root", default='/dataset2/gjw/Data/TestDataset')
    parser.add_argument("--record_path", default=None)
    parser.add_argument("--BR", default='off')
    parser.add_argument("--br_rate", default=15)
    args = parser.parse_args()
    datasets =['CAMO', 'CHAMELEON','NC4K', 'COD10K']
    #datasets = ['COD10K']
